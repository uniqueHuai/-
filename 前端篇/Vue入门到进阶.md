...
|   Vue 3.5    |   2024.9   | ⭐ Reactive Props 解构、`useTemplateRef`、`onWatcherCleanup` |
|  Vue 3.5.13  |  2024.11   | 3.5 系列稳定版                                  |
|  Vue 3.5.14  |   2025.5   | SSR 优化、包体积缩减                               |
|  Vue 3.5.34  |   2026.5   | ⭐ **最新稳定版**（持续修复至 2026.5）                 |
| **Vue 3.6**  | 2025.12~   | 🔶 **Beta 阶段**（当前 beta.12），新响应式 API、SSR 改进 |

> [!tip] 目前 **Vue 3.5.x** 是生产稳定版，**Vue 3.6** 正在 Beta 测试中（最新 beta.12），预计不久将发布正式版。
